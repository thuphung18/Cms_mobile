...
class _PostListScreenState extends State<PostListScreen> {
  ...
  void _handleLogout() async {
    ...
    if (mounted) {
      // Dùng pushAndRemoveUntil để xóa sạch lịch sử Admin, ép app quay về User Screen
    ...
    if (confirm) {
      ...
      if (mounted && !success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Yêu cầu đang được đồng bộ ngầm với hệ thống.'),
                        ...
                        return Card(
                          ...
                          child: ListTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () =>
                                  _handleDeletePost(post.id, post.name ?? ''),
                            ),
                            onTap: () {
                              Navigator.push(
                                context,
